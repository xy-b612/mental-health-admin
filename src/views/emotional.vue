<template>
  <div>
    ...
    <el-dialog v-model="detailDialogVisible" title="情绪日志" width="800px" :close-on-click-modal="false">
...
import { getEmotionalPage, deleteEmotion } from '@/api/admin.js'
...
const formItem = [
  ...
  {
    comp: 'select', prop: 'moodScroeRange', label: '情绪评分', placeholder: '请选择评分范围',
    options: [
      {
        label: '低分（1-3）',
        value: '1-3'
