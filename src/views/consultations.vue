<template>
  <div>
    ...
    <el-dialog v-model="showDetailDialog" title="咨询会话性情" width="70%" :close-on-click-modal="false">
      <div class="session-detail">
        ...
        <div class="messages-container">
          ...
          <div class="messages-list" v-loading="loadingMessage">
            <div class="message-item" :class="message.senderType === 1 ? 'user-message' : 'ai-message'"
              v-for="message in sessionMessages" :key="message.id">
              <div class="message-header">
...
import { getConsultionPage, getSessionDetail } from '@/api/admin.js'
...
const handleSearch = () => {
  getConsultionPage(pagination).then(res => {
